...
\end{itemize}
\\
The advantages of the proposed feature selection method is that it avoids the high computation cost of wrapper methods, thus reducing the time taken. It also ensures that correlations between features are not ignored and are given relative importance to other features that may have more of a significant relation to the dependent variable, ensuring a higher prediction accuracy. However, an error in expert opinion could result in the exclusion of predictors that may otherwise be relevant to the task at hand. This could potentially result in an increase in error of prediction, posing as a disadvantage of the proposed feature selection method.
